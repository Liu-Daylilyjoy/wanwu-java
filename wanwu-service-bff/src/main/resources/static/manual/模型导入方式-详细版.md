...
登录元景万悟，点击模型管理-模型导入-联通元景-模型类型rerank，依次填写模型名称、API Key、推理url
...
导入步骤同Text Embedding，筛选VL-Embedding![image-20260401111335987](assets/image-20260401111335987.png)

【模型名称】请求示例中的model，如qwen3-vl-embedding-8b

【API Key】第一步中申请的API Key

【推理url】https://maas-api.ai-yuanjing.com/openapi/compatible-mode/v1

登录元景万悟，点击模型管理-模型导入-联通元景-模型类型多模态向量化，依次填写模型名称、API Key、推理url

![image-20260416112751840](assets/image-20260416112751840.png)

### Multimodal Rerank-多模态重排序

![image-20260416112640822](assets/image-20260416112640822.png)

【模型名称】请求示例中的model，如qwen3-vl-reranker-2b

【API Key】第一步中申请的API Key

【推理url】https://maas-api.ai-yuanjing.com/openapi/v1/yuanjing/reranker

登录元景万悟，点击模型管理-模型导入-联通元景-模型类型多模态重排序，依次填写模型名称、API Key、推理url

![image-20260416112427735](assets/image-20260416112427735.png)
...
导入步骤同Text Rerank，https://help.aliyun.com/zh/model-studio/multimodal-embedding-api-reference?spm=a2c4g.11186623.help-menu-search-2400256.d_3#5a90b06032v0e

![image-20260401110158513](assets/image-20260401110158513.png)

【模型名称】查看“API参考”-模型名称，如qwen3-vl-embedding

【API Key】第一步中申请的API Key

【推理url】https://dashscope.aliyuncs.com/api/v1/services/embeddings/multimodal-embedding/multimodal-embedding

登录元景万悟，点击模型管理-模型导入-通义千问-模型类型“Multimodal Embedding”，依次填写模型名称、API Key、推理url

![image-20260401110330533](assets/image-20260401110330533.png)
...
导入步骤同LLM，模型接口文档链接如下：https://help.aliyun.com/zh/model-studio/text-rerank-api?spm=a2c4g.11186623.help-menu-2400256.d_2_11_0.3c91984ciMq1wd&scm=20140722.H_2780056._.OR_help-T_cn~zh-V_1

![image-20260416111820394](assets/image-20260416111820394.png)

【模型名称】qwen3-vl-rerank

【API Key】第一步中申请的API Key

【推理url】https://dashscope.aliyuncs.com/api/v1

登录元景万悟，点击模型管理-模型导入-通义千问-模型类型“多模态重排序”，依次填写模型名称、API Key、推理url



![image-20260416111530521](assets/image-20260416111530521.png)
...
1、 配置 智谱AI开放平台 获取 API Key https://bigmodel.cn/usercenter/proj-mgmt/apikeys

![image-20260401102048158](assets/image-20260401102048158.png)

![image-20260401102108815](assets/image-20260401102108815.png)

2、获取参数：选择想要导入的模型https://bigmodel.cn/console/modelcenter/square

进入模型广场-选择模型-点击查看详情和API参考，或直接查看API文档页面https://docs.bigmodel.cn/api-reference/%E6%A8%A1%E5%9E%8B-api/%E5%AF%B9%E8%AF%9D%E8%A1%A5%E5%85%A8

![image-20260401102359784](assets/image-20260401102359784.png)

![image-20260401102518750](assets/image-20260401102518750.png)

【模型名称】model，如glm-5

【API Key】第一步中申请的API Key

【推理url】https://open.bigmodel.cn/api/paas/v4

3、登录元景万悟，点击模型管理-模型导入-智谱-模型类型LLM，依次填写模型名称、API Key、推理url

![image-20260401103101487](assets/image-20260401103101487.png)

### Text Embedding-文本向量化

导入步骤同LLM，只需在文档中心中搜索“文本嵌入”模型即可

![image-20260401102822064](assets/image-20260401102822064.png)

【模型名称】model，如embedding-3

【API Key】第一步中申请的API Key

【推理url】https://open.bigmodel.cn/api/paas/v4

3、登录元景万悟，点击模型管理-模型导入-智谱-模型类型Text Embedding，依次填写模型名称、API Key、推理url

![image-20260401103133156](assets/image-20260401103133156.png)

### Text Rerank-文本重排序

导入步骤同LLM，只需在文档中心中搜索“文本重排序”模型即可

![image-20260401102955206](assets/image-20260401102955206.png)
...
3、登录元景万悟，点击模型管理-模型导入-智谱-模型类型Text Rerank，依次填写模型名称、API Key、推理url

![image-20260401103203853](assets/image-20260401103203853.png)
