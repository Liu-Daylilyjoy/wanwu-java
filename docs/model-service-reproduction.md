...
- Callback inference parity beyond OpenAI-compatible chat stream/non-stream with image URL data conversion plus embeddings/rerank JSON proxying and usage statistics: broader multimodal conversion, provider-specific adapters, and callback auth/signature checks remain missing.
