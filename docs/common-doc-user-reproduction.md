...
- Search remains a lightweight Java scorer rather than Go's riot search engine, so full Chinese tokenization and riot's internal ranking are not exact Go parity yet.
