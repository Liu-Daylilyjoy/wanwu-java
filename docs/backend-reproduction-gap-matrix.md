...
| `KnowledgeBaseService` | 28 | Partially covered with Docker MySQL snapshot-backed CRUD/list/hit shell plus external API and external knowledge mount lifecycle |
