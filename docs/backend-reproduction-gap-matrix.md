...
17. WGA/general agent: WanwuBot frontend routes are now exposed through a Java compatibility shell; continue with real WGA sandbox execution, persistent workspace artifacts, OpenClaw, and sub-agent orchestration only after the remaining frontend-visible backend gaps are closed.
