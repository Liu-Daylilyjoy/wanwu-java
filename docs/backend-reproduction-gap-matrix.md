...
| `KnowledgeBaseDocService` | 26 | Partially covered with Docker MySQL snapshot-backed doc import/list/delete/url-analysis/default segment, segment create/update/delete/status/labels, and local ZIP export records; real file parsing, chunk indexing, MinIO async exports, reimport, child segment persistence, and async status callbacks missing |
