...
| `KnowledgeBaseService` | 28 | Partially covered with Docker MySQL snapshot-backed CRUD/list, local document-segment hit test, external API, and external knowledge mount lifecycle; real RAG/vector/rerank retrieval and normalized tables missing |
